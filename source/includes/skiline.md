...
Base response is JSON object with 2 keys, total - number of all results matched by query, resources - array of results
...
-----------|--------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
 ...
 survey    | object | Survey object: _id - survey ID, name - survey localization name object, overallScore - survey max scoring.                                                                                             |
...
For the next results data processing Screver prepare "answerProcessed" parsed object that contain all related data of survey and questions.
Each key of object is "surveyItemId" - unique ID of survey element that contain question data and other configurations.
